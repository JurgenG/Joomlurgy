...
<tr>
    <td class="sectiontableheader" width="40%"><?php echo JText::_('COM_JOOMLURGY_JOOMLURGYEVENTS_NAME');?></td>
	
	<td class="sectiontableheader" width="20%"><?php echo JText::_('COM_JOOMLURGY_JOOMLURGYEVENTS_SCRIPTURE1');?></td>
	<td class="sectiontableheader" width="20%"><?php echo JText::_('COM_JOOMLURGY_JOOMLURGYEVENTS_SCRIPTURE2');?></td>
	<td class="sectiontableheader" width="20%"><?php echo JText::_('COM_JOOMLURGY_JOOMLURGYEVENTS_GOSPEL');?></td>
</tr>
	...
	<td><a href="<?php echo JRoute::_('index.php?option=com_joomlurgy&view=joomlurgyevent&id=' . (int)$item->id); ?>"><?php echo $item->name; ?></a></td>
