...
?>
<?php if ($this->item) : ?>
<div class="componentheading"><?php echo JText::_('COM_JOOMLURGY_TITLE') ;?> <?php echo $this->item['joomlurgysaint_detail']->name; ?></div>
    ...
    ?>
        ...
        <!---  Scripture1  -->
        <h2><?php echo $this->item['joomlurgysaint_detail']->scripture1; ?></h2>
    ...
    if (!empty($this->item['scripture1'])) {
        ...
        <!---  Scripture2  -->
        <h2><?php echo $this->item['joomlurgysaint_detail']->scripture2; ?></h2>
    ...
    if (!empty($this->item['scripture2'])) {
        ...
        <!---  Gospel  -->
        <h2><?php echo $this->item['joomlurgysaint_detail']->gospel; ?></h2>
        <ul class="item_fields">
    <?php
