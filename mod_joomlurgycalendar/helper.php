...
function mc_init_debug() {
    ...
    $xml_array = JApplicationHelper::parseXMLInstallFile(JPATH_ROOT . '/modules/mod_joomlurgycalendar/mod_joomlurgycalendar.xml');
    mc_trace("\nJoomlurgyCalendar ver : " . $xml_array['version']);
...
function mc_trace($data) {
    @file_put_contents(JPATH_ROOT . '/modules/mod_joomlurgycalendar/trace.txt', $data . "\n", FILE_APPEND);
}
